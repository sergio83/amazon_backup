...
// Parsing MongoDB URI mongodb://<user>:<password>@<host>:<port>/<database>
...
module.exports.handler = (event, context, cb)=> {
  ...
  exec(`mongodump -h ${host} -d ${dbName} -u ${username} -p ${pass} -o ${folderName} --authenticationDatabase admin`, (error, stdout, stderr)=> {
    if (error) {
